...
echo ''; 
echo ''; # URL path
echo ''; # secure host (do not use one)
echo cjg\@ecs.soton.ac.uk; # admin email
echo My Archive; # archive name
echo '';
...
echo ''; # init user?
echo ''; # username
echo 'admin'; # user type
echo 'admin'; # password
echo 'chris\@totl.net'; # user email
...
# run indexer through on level 5 verbose
run( "$bin/indexer --once --notdaemon --loglevel 5 start" );
